...
?>	
  ...
  include'../vista/registro/agregar.php';
	...
	<form class="navbar-form navbar-left" action="../Importar_excel_cliente.php" >       
		<button data-toggle="modal" href="#eliminar" class="btn btn-info">Exportar a Excel - Acumulado</button>
	</form>
	<form class="navbar-form navbar-left" action="../Importar_excel_asesores.php" >       
    <button data-toggle="modal" href="#eliminar" class="btn btn-info">Exportar a Excel - Asesores</button>
  </form>
	<div class="row">
			<div class="col-md-12">
